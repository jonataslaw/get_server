...
abstract class Widget {
  ...
  @protected
  @factory
  Element createElement(ContextRequest request, Stream<GetSocket> socketStream);
}
...
abstract class Element implements BuildContext {
  ...
  Element(Widget widget, ContextRequest request, Stream<GetSocket> socketStream)
      : assert(widget != null),
        request = request,
...
abstract class StatelessWidget extends Widget {
  ...
  StatelessElement createElement(
      ContextRequest request, Stream<GetSocket> socketStream) {
    final element = StatelessElement(this, request, socketStream);
    build(element).createElement(request, socketStream);
    return element;
  }
...
class StatelessElement extends ComponentElement {
  ...
  StatelessElement(StatelessWidget widget, ContextRequest request,
